...
<div class="container-fluid container py-4">
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="sidebar">
                <!-- Custom Toggle Button for Mobile/Tablet -->
                <button style="background: #002f3c;" class="btn w-100 d-lg-none mb-3 d-flex justify-content-between align-items-center"
                    type="button" id="mobileFilterBtn">
                    <span style="color: white;"><i class="fa fa-filter"></i> Filter Options</span>
                    <span class="dropdown-toggle"></span>
                </button>

                <!-- Wrapper (Hidden on mobile by default, always visible on desktop) -->
                <div class="d-none d-lg-block" id="filterAccordion">
            ...
            <script>
                document.getElementById('mobileFilterBtn').addEventListener('click', function() {
                    var filterMenu = document.getElementById('filterAccordion');

                    // Toggle visibility strictly for mobile/tablet
